...
{
    Library   classUnderTest = new Library();
    List<String> votesTest = new ArrayList<>();
    votesTest.add("Shrub");
    votesTest.add("Shrub");
    votesTest.add("Shrub");
    votesTest.add("Hedge");
    ...
    votesTest.add("Shrub");
    votesTest.add("Shrub");
    String newResult = Library.tally(votesTest);
    assertEquals("Shrub",newResult);
...
void minMaxTest()
{
    ...
    HashSet notSeenResult =  Library.minMax(arr);

    assertEquals(<67, 68, 69, 63>,notSeenResult);
}
